 ...
 *       &lt;sequence>
 *         &lt;element name="return" type="{http://vangoghpaintstore.provider.services.estore.example.mulesoft.com/}product" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "getProductInfoResponse", namespace = "http://vangoghpaintstore.provider.services.estore.example.mulesoft.com/", propOrder = {
    "_return"
})
